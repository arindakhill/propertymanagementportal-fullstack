      ...
      >
        ...
        >
          ...
          >
            {!isOwner && !isAdmin ? (
              <>
                Discover a place where every detail feels{' '}
                <span style={{ color: 'blue' }}>tailor-made for you</span> -
                because it is. Explore our curated listings to find homes that{' '}
                <span style={{ color: 'blue' }}>embody modern living</span> and
                reflect the aspirations of discerning buyers like yourself. With
                our diverse range of properties, you can turn your dream of
                homeownership into a reality.
              </>
            ) : isOwner ? (
              <>
                Welcome to your platform for selling properties effortlessly.
                Our streamlined process and expert guidance ensure that your
                property stands out in the market, attracting the right buyers
                and maximizing its value. List your property with us today and
                embark on a journey to a successful sale.
              </>
            ) : (
              <>
                As an admin, you have the power to manage the platform and
                ensure that all users have a seamless experience. You can view
                and manage all properties and users, and make any necessary
                changes to the platform. Your role is crucial in maintaining the
                integrity and functionality of the platform.
              </>
            )}
          </Text>
          ...
          {user && user.role == 'CUSTOMER' && (
            <Link to="/favorites">
              {' '}
              <Button colorScheme="teal" alignSelf={true}>
                My Favourites
              </Button>{' '}
            </Link>
          )}
        ...
        <VStack justify="center">
          ...
          {isCustomer && (
            <Box h="100%" display={{ base: 'none', lg: 'block', xl: 'none' }}>
              <Image src={House2Lg} alt="house" h="200%" objectFit="cover" />
            </Box>
          )}
          {isCustomer && (
            <Box h="50%" display={{ base: 'none', xl: 'block' }}>
